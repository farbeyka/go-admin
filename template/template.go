...
import (
	...
	errors2 "github.com/farbeyka/go-admin/modules/errors"
	"github.com/farbeyka/go-admin/modules/language"
	"github.com/farbeyka/go-admin/modules/logger"
	"github.com/farbeyka/go-admin/modules/menu"
	...
	"github.com/farbeyka/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/farbeyka/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/farbeyka/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
